...
ActiveRecord::Schema[7.1].define(version: 2026_03_18_190000) do
  ...
  create_table "aftercare_audit_events", force: :cascade do |t|
    t.bigint "account_id", null: false
    t.bigint "aftercare_enrollment_id"
    t.string "actor_type"
    t.bigint "actor_id"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["account_id"], name: "index_aftercare_audit_events_on_account_id"
    t.index ["actor_type", "actor_id"], name: "index_aftercare_audit_events_on_actor"
    t.index ["aftercare_enrollment_id"], name: "index_aftercare_audit_events_on_aftercare_enrollment_id"
  end

  create_table "aftercare_dispatch_logs", force: :cascade do |t|
    t.bigint "aftercare_enrollment_id", null: false
    t.bigint "aftercare_enrollment_step_id", null: false
    t.bigint "message_id"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["aftercare_enrollment_id"], name: "index_aftercare_dispatch_logs_on_aftercare_enrollment_id"
    t.index ["aftercare_enrollment_step_id", "attempt_key"], name: "index_aftercare_dispatch_logs_on_step_and_attempt_key", unique: true
    t.index ["aftercare_enrollment_step_id"], name: "index_aftercare_dispatch_logs_on_aftercare_enrollment_step_id"
    t.index ["message_id"], name: "index_aftercare_dispatch_logs_on_message_id"
  end

  create_table "aftercare_enrollment_steps", force: :cascade do |t|
    t.bigint "aftercare_enrollment_id", null: false
    t.bigint "aftercare_sequence_step_id"
    t.integer "position", null: false
    t.string "title", null: false
    t.text "instructions"
    t.integer "status", default: 0, null: false
    t.integer "draft_status", default: 0, null: false
    ...
    t.jsonb "draft_input_snapshot", default: {}, null: false
    t.text "draft_error"
    t.index ["aftercare_enrollment_id", "position"], name: "index_aftercare_enrollment_steps_on_enrollment_and_position", unique: true
    t.index ["aftercare_enrollment_id"], name: "index_aftercare_enrollment_steps_on_aftercare_enrollment_id"
    t.index ["aftercare_sequence_step_id"], name: "index_aftercare_enrollment_steps_on_aftercare_sequence_step_id"
  end

  create_table "aftercare_enrollments", force: :cascade do |t|
    t.bigint "account_id", null: false
    t.bigint "conversation_id", null: false
    t.bigint "contact_id", null: false
    t.bigint "inbox_id", null: false
    t.bigint "aftercare_sequence_id", null: false
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["account_id", "idempotency_key"], name: "index_aftercare_enrollments_on_account_id_and_idempotency_key", unique: true
    t.index ["account_id"], name: "index_aftercare_enrollments_on_account_id"
    t.index ["aftercare_sequence_id"], name: "index_aftercare_enrollments_on_aftercare_sequence_id"
    t.index ["contact_id"], name: "index_aftercare_enrollments_on_contact_id"
    t.index ["conversation_id"], name: "index_aftercare_enrollments_on_conversation_id"
    t.index ["created_by_id"], name: "index_aftercare_enrollments_on_created_by_id"
    t.index ["inbox_id"], name: "index_aftercare_enrollments_on_inbox_id"
  end

  create_table "aftercare_opt_in_subscriptions", force: :cascade do |t|
    t.bigint "aftercare_enrollment_id", null: false
    t.integer "status", default: 0, null: false
    t.string "topic", null: false
    t.string "provider", default: "meta", null: false
    t.string "capability_status", default: "supported", null: false
    t.string "token_ref"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["aftercare_enrollment_id"], name: "idx_on_aftercare_enrollment_id_8ca50baacc"
    t.index ["aftercare_enrollment_id"], name: "index_aftercare_opt_in_subscriptions_on_enrollment_id", unique: true
  end

  create_table "aftercare_sequence_steps", force: :cascade do |t|
    t.bigint "aftercare_sequence_id", null: false
    t.integer "position", null: false
    t.string "title", null: false
    t.text "instructions"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["aftercare_sequence_id", "position"], name: "index_aftercare_sequence_steps_on_sequence_and_position", unique: true
    t.index ["aftercare_sequence_id"], name: "index_aftercare_sequence_steps_on_aftercare_sequence_id"
  end

  create_table "aftercare_sequences", force: :cascade do |t|
    t.bigint "account_id"
    t.string "code", null: false
    t.string "name", null: false
    t.text "description"
    t.string "channel_scope", default: "messenger_instagram", null: false
    t.string "opt_in_topic", null: false
    t.string "default_timezone", default: "Asia/Bangkok", null: false
    t.boolean "active", default: true, null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["account_id"], name: "index_aftercare_sequences_on_account_id"
    t.index ["code"], name: "index_aftercare_sequences_on_code", unique: true
  end
  ...
  create_table "contact_memories", force: :cascade do |t|
    ...
    t.string "category", default: "fact"
    t.vector "embedding", limit: 1536
    t.tsvector "search_vector"
    t.jsonb "metadata", default: {}
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["account_id"], name: "index_contact_memories_on_account_id"
    t.index ["category"], name: "index_contact_memories_on_category"
    t.index ["contact_id", "created_at"], name: "index_contact_memories_on_contact_id_and_created_at", order: { created_at: :desc }
    t.index ["contact_id"], name: "index_contact_memories_on_contact_id"
    t.index ["embedding"], name: "index_contact_memories_on_embedding", opclass: :vector_cosine_ops, using: :hnsw
    t.index ["search_vector"], name: "index_contact_memories_on_search_vector", using: :gin
  end
  ...
  add_foreign_key "aftercare_dispatch_logs", "aftercare_enrollments"
  add_foreign_key "aftercare_dispatch_logs", "messages"
  add_foreign_key "aftercare_enrollment_steps", "aftercare_enrollments"
  add_foreign_key "aftercare_enrollment_steps", "aftercare_sequence_steps"
  add_foreign_key "aftercare_enrollments", "accounts"
  add_foreign_key "aftercare_enrollments", "aftercare_sequences"
  add_foreign_key "aftercare_enrollments", "contacts"
  add_foreign_key "aftercare_enrollments", "conversations"
  add_foreign_key "aftercare_enrollments", "inboxes"
  add_foreign_key "aftercare_enrollments", "users", column: "created_by_id"
  add_foreign_key "aftercare_opt_in_subscriptions", "aftercare_enrollments"
  add_foreign_key "aftercare_sequence_steps", "aftercare_sequences"
  add_foreign_key "aftercare_sequences", "accounts"
  add_foreign_key "contact_memories", "accounts"
