class TriggerScheduledItemsJob < ApplicationJob
  ...
  def perform
    ...
    # Job to replay unanswered customer messages back to chatbotlevan
    AiControl::ReplayUnansweredConversationsJob.perform_later

    # Job to sync whatsapp templates
    Channels::Whatsapp::TemplatesSyncSchedulerJob.perform_later

    # Job to enqueue due aftercare steps
    Aftercare::ProcessDueStepsJob.perform_later
