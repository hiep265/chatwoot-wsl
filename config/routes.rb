Rails.application.routes.draw do
  ...
  if ActiveModel::Type::Boolean.new.cast(ENV.fetch('CW_API_ONLY_SERVER', false))
    ...
    root to: redirect('/simple', status: 302)

    get '/simple', to: 'dashboard#index'
    get '/simple/*params', to: 'dashboard#index'
    ...
    namespace :v1 do
      ...
      resources :accounts, only: [:create, :show, :update] do
        ...
        scope module: :accounts do
          ...
          get 'ai_control/manager/unassigned_hot_queue', to: 'ai_control#manager_unassigned_hot_queue'
          get 'ai_control/manager/customer_360', to: 'ai_control#manager_customer_360'
          get 'ai_control/manager/reply_gap_watch', to: 'ai_control#manager_reply_gap_watch'
          get 'ai_control/manager/priority_digest', to: 'ai_control#manager_priority_digest'
